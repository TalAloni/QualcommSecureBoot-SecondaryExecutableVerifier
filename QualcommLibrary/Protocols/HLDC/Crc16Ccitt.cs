...
namespace QualcommLibrary.Protocols.HDLC
{
    ...
    {
        public static ushort[] CRC16_CCITT_TABLE = new ushort[]{
        ...
        public static ushort ComputeChecksum(byte[] buffer, int count)
        {
            return ComputeChecksum(buffer, 0, count);
        }
        ...
        public static ushort ComputeChecksum(byte[] buffer, int offset, int count)
        {
            ...
            {
                crc = (ushort)((crc >> 8) ^ CRC16_CCITT_TABLE[(crc ^ buffer[index]) & 0xff]);
            }
